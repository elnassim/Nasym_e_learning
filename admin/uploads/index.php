...
<body class="ground">
    <header>
        <div class="logo"><img class="lggg" src="image/LGG.png" alt="logo"></div>
        <nav>
            <ul class="left">
    ...
    <section class="about" id="about">
        ...
        <div class="about-container">
            <div class="about-box">
             ...
             <button class="login-btn" onclick="showTeachersign()">
                sign-up
                </button>
            </div>
            <div class="about-box" >
            ...
            <div class="about-box">
                <h2>As a student</h2>
                <p>Connection as a student here.</p>
                <button class="login-btn" onclick="showStudentLogin()">
                Log in
                </button>
                <button class="login-btn" onclick="showStudentsign()">
                    sign-up
                    </button>
            </div>
        </div>  
    ...
    <section class="services" id="services">
        <h1>Our Services</h1>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 186 17" fill="none"><path d="M184.68 8.95006C169.95 1.68006 152.06 1.68006 137.32 8.95006C124.03 15.5101 107.9 15.5101 94.61 8.95006C79.88 1.68006 61.99 1.68006 47.25 8.95006C33.96 15.5101 17.83 15.5101 4.54 8.95006L1 7.43006"></path></svg>
    ...
    <section class="testimonials" id="testimonials">
        ...
        <div class="testimonials-container">
            <div class="testimonial-box">
                ...
                <p>"NASYM's personalized approach and unbiased insights were invaluable in my search process. Highly recommended!"</p>
                <div class="user-info">
    ...
    <footer>
        <p>&copy; 2024 NASYM. All rights reserved.</p>
        ...
        <div class="copyright">
            <p>Designed and developed by NASYM team.</p>
        </div>
    </footer>
    ...
    <script>
        ...
        window.location.href = "teacher/authentication/login.php";
        }
        

        function showStudentLogin() {
            // Show the student login page
            window.location.href = "student/authentication/login.php";
        }
        ...
        function showTeachersign() {
           
           window.location.href = "teacher/authentication/register.php";
           }
        function showStudentsign() {
           
           window.location.href = "student/authentication/register.php";
           }
    </script>
    <style>
       body {
  ...
  background-image: url('image/background.jpeg'); /* Assurez-vous que le chemin de l'image est correct */
