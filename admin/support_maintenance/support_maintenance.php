...
$query = "SELECT * FROM CourseResources";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['courseId']) && isset($_POST['visibility'])) {
        ...
        // Perform the update in the database (replace this with your actual update code)
        // ...

        // Set the status message based on the update result
        $statusMessage = "Visibility for Course ID: $courseId updated successfully!";
    }
}
...
// Set the status message in the session if it exists
...
<div class="dashboard-container">
    ...
    <main>
        ...
        <section>
    <h2>Modify Existing Resources</h2>
            ...
            <tbody>
                <?php foreach ($resources as $resource) : ?>
                    <tr>
                        ...
                        <td><?php echo getCourseTitle($resource['CourseID']); ?></td>
                        <td>
                            <a href="delete_resource.php?resourceId=<?php echo $resource['ResourceID']; ?>" class="btn-delete">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <?php endif; ?>
        ...
        <section>
            <h2>Control Resource Visibility</h2>
            ...
            <form action="update_visibility.php" method="POST">
                ...
                <input type="radio" name="visibility" value="visible" checked> All content visible
                <input type="radio" name="visibility" value="progressive"> Visible progressively
                <button type="submit" class="btn-update">Update</button>
            </form>
        </section>
    </main>
    <?php
// Helper function to get the course title based on the course ID
